...
def run_classification(message_config: dict, model="claude-sonnet-4-20250514", max_tokens=600) -> str:
...
def generate_structutred_suggestions(row: pd.Series) -> dict:
...
def build_classification_prompt(row: pd.Series) -> dict:
    ...
    suggestions = generate_structutred_suggestions(row)
